...
public class RoundRectHelper {
    ...
    public RoundRectHelper(Context context, AttributeSet attrs, View targetView) {
        ...
        if(attrs != null){
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.NewsRoundRectLayout);

            mRadius = ta.getDimensionPixelOffset(R.styleable.NewsRoundRectLayout_newsRatio,0);
            mBackgroundColor = ta.getColor(R.styleable.NewsRoundRectLayout_newsBackgroundColor, Color.WHITE);
